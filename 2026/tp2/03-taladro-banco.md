...
Es una máquina herramienta [⌕](../../images/tp2/benchdrill_01_360px.jpg) que se utiliza para realizar perforaciones precisas en distintos materiales, especialmente metal, madera y plástico. Permite trabajar trabajar con mayor estabilidad, seguridad y exactitud que el taladro portátil gracias a su estructura rígida y a la regulación de velocidad.

Sus partes principales son: la base, que sostiene toda la máquina; la columna, que da soporte vertical; la mesa de trabajo, donde se apoya la pieza; el motor; el sistema de transmisión; el husillo (eje giratorio), el mandril [⌕](../../images/tp2/drilling_mandril_01_260__pixabay__sin atrib.jpg) que sujeta la broca; y la palanca de avance, que permite bajar la broca para realizar la perforación.


**Actividad:**

Dibuja un esquema del taladro de banco siguiendo, si quieres, el modelo de abajo. Luego señala en el dibujo las partes principales que se nombran.
