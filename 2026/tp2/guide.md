---
title: "TP 2: Corte y agujereado en metal blando"
autor: "José Juarez"
version: "//26"
---
...
Este trabajo te permite practicar corte y agujereado en un material más duro con la madera. Usarás el taladro de banco.

<br>

### Plano del TP

Aquí el plano pide unas tolerancias un poco menores para que vayas gananado en precisión. El material de partida es un año estructural de 20x10.

**Actividad:** Hacer el plano a mano alzada siguiendo el modelo en papel.

<br>

### Calibre Vernier (Pie de rey)

En esta materia vas a conocer y usar más a fondo este instrumento de medición. Empezarás por repasar sus partes principales.

**Actividad:** Hacer a mano alzada un dibujo de un calibre siguiendo el modelo en papel. 

<br>

### El taladro de banco

Es una máquina herramienta fija que se utiliza para realizar perforaciones precisas en distintos materiales, especialmente metal, madera y plástico. A diferencia del taladro manual, permite trabajar con mayor estabilidad, seguridad y exactitud gracias a su estructura rígida y a la regulación de velocidad.

Sus partes principales son: la base, que sostiene toda la máquina; la columna, que da soporte vertical; la mesa de trabajo, donde se apoya la pieza; el motor; el sistema de transmisión; el husillo y el mandril, que sujetan la broca; y la palanca de avance, que permite bajar la broca para realizar la perforación.

**Actividad:** Dibuja un esquema del taladro de banco siguieno, si quieres, el modelo de abajo. Luego señala en el dibujo las partes principales que se nombran.

<!-- Image -->
<br>
   <center>![](benchdrill_01__vectorportal__con atrib.svg){width=400px}</center>
   <center>
      <span class="grey3 size70"></span>
      <span class="grey3 size50">Fuente: Vectorportal</span>
   </center>
<br>
