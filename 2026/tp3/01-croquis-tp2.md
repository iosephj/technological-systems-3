...
Aquí el croquis señala una tolerancia aun menor que las anteriores para que vayas gananado en precisión. El material de partida es un perfil redondo de 22 mm, de acero SAE 1020 (acero blando).

**Actividad:** Hacer el croquis a mano alzada siguiendo el modelo mostrado. Los signos **=** en la cota significa que ambas medidas son iguales y que el agujero está centrado.

<!-- Image -->
   <center>![](tp3/croquis.jpg){}</center>
