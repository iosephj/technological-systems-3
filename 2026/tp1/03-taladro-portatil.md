...
El taladro portátil [⌕](../../images/tp1/hand_drill_01_320px__pixabay__gratis sin reconocimiento.jpg) es una máquina normalmente usada para perforar con brocas (mechas).

Puede:

- ser a batería  [⌕](../../images/tp1/hand_drill_03_320px__freeimage.jpg),
- usarse también para atornillar [⌕](../../images/tp1/hand_drill_screwing_01_490px__pixabay__sin atrib.jpg),
- usarse para otras funciones poniéndole herramientas específicas.


**Actividad:** Hacer a mano alzada un dibujo de un taladro portátil según el modelo provisto en papel. Poner sus partes principales segun se explicó en clase.

<span hidden> para 2027: agregar una pregunta sobre causas cuando no perfora, giro invertido, desafilado</span>
